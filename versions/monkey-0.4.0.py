...
# TODO: Fix bug where banana value won't change
...
def sys():
    ...
    if syschoice == "1":
        ...
        sysexit = input("Are you sure you want to exit? (y/n) ")
        if sysexit == "y":
            print("")
            return
        else:
        ...
        print("Invalid Choice! Going back to Home Screen in 3 seconds...\n")
        sleep(3);sys()
